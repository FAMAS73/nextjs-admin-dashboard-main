  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.25 4A.75.75 0 013 3.25h18a.75.75 0 01.75.75v3a.75.75 0 01-.75.75H3A.75.75 0 012.25 7V4zm1.5.75v1.5h16.5v-1.5H3.75zM2.25 10a.75.75 0 01.75-.75h18a.75.75 0 01.75.75v3a.75.75 0 01-.75.75H3a.75.75 0 01-.75-.75v-3zm1.5.75v1.5h16.5v-1.5H3.75zM2.25 16a.75.75 0 01.75-.75h18a.75.75 0 01.75.75v3a.75.75 0 01-.75.75H3a.75.75 0 01-.75-.75v-3zm1.5.75v1.5h16.5v-1.5H3.75z"
      />
      <circle cx="5" cy="5.5" r=".75" fill="currentColor" />
      <circle cx="5" cy="11.5" r=".75" fill="currentColor" />
      <circle cx="5" cy="17.5" r=".75" fill="currentColor" />
    </svg>
  );
}

export function ConfigIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
...
export function TimingIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
...
export function RaceFlag(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
...
export function TrophyIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
...
export function ControlIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.25c-2.487 0-4.75.671-6.694 1.82a.75.75 0 00.388 1.394c1.7-.102 3.45-.102 5.056 0h2.5c1.606.102 3.356.102 5.056 0a.75.75 0 00.388-1.394A12.75 12.75 0 0012 1.25zM2.25 8c0-.966.784-1.75 1.75-1.75h16a1.75 1.75 0 011.75 1.75v8A1.75 1.75 0 0120 17.75H4A1.75 1.75 0 012.25 16V8zM4 7.75a.25.25 0 00-.25.25v8c0 .138.112.25.25.25h16a.25.25 0 00.25-.25V8a.25.25 0 00-.25-.25H4z"
      />
